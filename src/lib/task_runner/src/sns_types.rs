...
pub const NEURON_SUBACCOUNT: [u8; 32] = [
    0x4d, 0xe6, 0x73, 0xe9, 0xcd, 0x7a, 0x13, 0x39, 0xaf, 0xea, 0x65, 0x23, 0xa5, 0xf2, 0x27, 0xd2,
    0x5e, 0x9d, 0x73, 0x9f, 0xf5, 0x26, 0x35, 0xac, 0x86, 0xdb, 0xdb, 0x04, 0x47, 0xae, 0x10, 0x6a,
];
